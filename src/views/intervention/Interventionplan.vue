<template>
  <div id="analysis" style="text-align:left;">
    <div>
      ...
      <div id="page">
        <div class="menu-list">
          <div class="total" :class="{active:item.id === sel}" v-for="item in tabs" :key="item.id"
               @click="select(item)">
          ...
          <div class="all" v-if="sel === 1">
            <div style="height: 700px; width:99.9%; border:1px solid #DCDFE6">
              <div style="height: 500px; width:905px;margin-top:3%;margin-left:25%">
                <div>
                  <el-table ref="singleTable" border :data="tableData" tooltip-effect="dark" highlight-current-row
                            style="width: 100%;font-size: 18px" @current-change="handleSelectionChange">
                ...
                <el-button type="primary" style="margin-top:20px;font-size: 18px" @click="chooseusers(item)">确认
                </el-button>
              </div>
            </div>
          </div>
          <div class="all" v-if="sel === 2">
            <div style="height:600px; width:90%; border:1px solid #DCDFE6;margin-left: 5%;margin-top: 5%;padding-left: 20px;padding-right: 20px">
              <el-row :gutter="40">
                <el-col :span="8">
                  <input type="button" class="emotion" id="part1" value="分面1：暴乱" style="margin:7% 30% 10%"
                         @click="part1(item)">
                </el-col>
                <el-col :span="8">
                  <input type="button" class="emotion" id="part2" value="分面2：香港青年" style="margin:7% 30% 10%"
                         @click="part2(item)">
                </el-col>
                <el-col :span="8">
                  <input type="button" class="emotion" id="part3" value="分面3：五眼联盟" style="margin:7% 30% 10%"
                         @click="part3(item)">
                </el-col>
                <!--              <input type="button" class="emotion" id="part1" value="分面1：暴乱" style="margin:7% 10%" @click="part1(item)">-->
                <!--              <input type="button" class="emotion" id="part2" value="分面2：香港青年" @click="part2(item)">-->
                <!--              <input type="button" class="emotion" id="part3" value="分面3：五眼联盟"style="margin:7% 10%"  @click="part3(item)">-->
              </el-row>
              <el-row :gutter="40">
                <el-col :span="8">
                  <el-tag class="description">
                    自2019年6月以来，反中乱港势力借反修例之名发动旷日持久的黑色暴乱。修例风波本质上是由反中乱港势力借题发挥、内外勾连策动的“颜色革命”，其目标就是企图颠覆香港秩序，夺取特区管治权，妄图阻碍中国发展。
                  </el-tag>
                </el-col>
                <el-col :span="8">
                  <el-tag class="description">
                    令人担忧的是，反中乱港势力鼓吹“违法达义”等歪理邪说，诱导青少年以暴力抗争来表达诉求，为达目的不惜毁掉年轻人的前程。警方资料显示，2019年6月至12月底，已有近2600名学生被捕，约占总被捕人数的4成。
                  </el-tag>
                </el-col>
                <el-col :span="8">
                  <el-tag  class="description">
                    当地时间2020年11月18日，澳大利亚、英国、加拿大、新西兰、美国外长发表联合声明干涉中国内政，妄称香港特区政府依法裁定4名反中乱港者丧失立法会议员资格的行为违反《中英联合声明》中所规定的具有法律约束力的国际义务，违背对香港‘高度自治’的承诺，以及违背‘言论自由’的权利”。
                  </el-tag>
                </el-col>
    ...
    export default {
        ...
        methods: {
            ...
            part1(item) {
                ...
                var secnum = (Math.random() * 5 + 5).toFixed(2)
                setTimeout(() => {
                    loading.close();
                    this.sel = 3;
                    this.emotion = '分面1：暴乱';
